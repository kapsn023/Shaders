...
// @ts-ignore
import ditherFragmentShader from './shaders/olddither.frag'

import * as gfx from 'gophergfx'


export class OldDitherMaterial extends gfx.Material3
{
    ...
    constructor()
    {
        ...
        OldDitherMaterial.shader.initialize(this.gl);

        this.kAmbientUniform = OldDitherMaterial.shader.getUniform(this.gl, 'kAmbient');
        this.kDiffuseUniform = OldDitherMaterial.shader.getUniform(this.gl, 'kDiffuse');
        this.kSpecularUniform = OldDitherMaterial.shader.getUniform(this.gl, 'kSpecular');
        this.shininessUniform = OldDitherMaterial.shader.getUniform(this.gl, 'shininess');

        this.textureUniform = OldDitherMaterial.shader.getUniform(this.gl, 'textureImage');
        this.useTextureUniform = OldDitherMaterial.shader.getUniform(this.gl, 'useTexture');

        this.modelUniform = OldDitherMaterial.shader.getUniform(this.gl, 'modelMatrix');
        this.normalModelUniform = OldDitherMaterial.shader.getUniform(this.gl, 'normalModelMatrix');
        this.viewUniform = OldDitherMaterial.shader.getUniform(this.gl, 'viewMatrix');
        this.projectionUniform = OldDitherMaterial.shader.getUniform(this.gl, 'projectionMatrix');

        this.eyePositionWorldUniform = OldDitherMaterial.shader.getUniform(this.gl, 'eyePositionWorld');
        this.numLightsUniform = OldDitherMaterial.shader.getUniform(this.gl, 'numLights');
        this.lightTypesUniform = OldDitherMaterial.shader.getUniform(this.gl, 'lightTypes');
        this.lightPositionsWorldUniform = OldDitherMaterial.shader.getUniform(this.gl, 'lightPositionsWorld');
        this.ambientIntensitiesUniform = OldDitherMaterial.shader.getUniform(this.gl, 'ambientIntensities');
        this.diffuseIntensitiesUniform = OldDitherMaterial.shader.getUniform(this.gl, 'diffuseIntensities');
        this.specularIntensitiesUniform = OldDitherMaterial.shader.getUniform(this.gl, 'specularIntensities');

        this.positionAttribute = OldDitherMaterial.shader.getAttribute(this.gl, 'position');
        this.normalAttribute = OldDitherMaterial.shader.getAttribute(this.gl, 'normal');
        this.colorAttribute = OldDitherMaterial.shader.getAttribute(this.gl, 'color');
        this.texCoordAttribute = OldDitherMaterial.shader.getAttribute(this.gl, 'texCoord');   
    }
    ...
    draw(mesh: gfx.Mesh3, camera: gfx.Camera, lightManager: gfx.LightManager): void
    {
        ...
        this.gl.useProgram(OldDitherMaterial.shader.getProgram());
