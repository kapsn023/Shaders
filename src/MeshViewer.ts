...
import { OldDitherMaterial } from './OldDitherMaterial';
import { NoiseDitherMaterial } from './NoiseDitherMaterial';
import { LargeDitherMaterial } from './LargeDitherMaterial';
...
export class MeshViewer extends gfx.GfxApp
{
    ...
    private ditherMaterial: DitherMaterial;
    private noiseDitherMaterial: NoiseDitherMaterial;
    private oldDitherMaterial: OldDitherMaterial;
    private largeDitherMaterial: LargeDitherMaterial;
    ...
    constructor()
    {
        ...
        this.ditherMaterial = new DitherMaterial();
        this.oldDitherMaterial = new OldDitherMaterial();
        this.noiseDitherMaterial = new NoiseDitherMaterial();
        this.largeDitherMaterial = new LargeDitherMaterial(
            new gfx.Texture('./assets/maps/White Noise Map 1.png'));
    ...
    private changeRenderStyle(): void
    {
       ...
       else if(this.renderStyle == 'Small Dithered')
       {
            this.models.forEach((model: gfx.Mesh3) => {
                model.material = this.ditherMaterial;
            });
       }
       else if(this.renderStyle == 'White Dithered')
       {
            this.models.forEach((model: gfx.Mesh3) => {
                model.material = this.largeDitherMaterial;
            });
       }
       else if(this.renderStyle == 'Old Dithered')
       {
            this.models.forEach((model: gfx.Mesh3) => {
                model.material = this.oldDitherMaterial;
            });
       }
       else if(this.renderStyle == 'Noise Dithered')
       {
            this.models.forEach((model: gfx.Mesh3) => {
                model.material = this.noiseDitherMaterial;
            });
       }
    }
    ...
    {
        this.ditherMaterial.ambientColor.set(1, 0.4, 0.4);
        this.ditherMaterial.diffuseColor.set(1, 0.4, 0.4);
        this.ditherMaterial.specularColor.set(1, 1, 1);
        this.ditherMaterial.shininess = 50;
        this.ditherMaterial.texture = null;

        this.largeDitherMaterial.ambientColor.set(1, 0.4, 0.4);
        this.largeDitherMaterial.diffuseColor.set(1, 0.4, 0.4);
        this.largeDitherMaterial.specularColor.set(1, 1, 1);
        this.largeDitherMaterial.shininess = 50;
        this.largeDitherMaterial.texture = null;


        this.oldDitherMaterial.ambientColor.set(1, 0.4, 0.4);
        this.oldDitherMaterial.diffuseColor.set(1, 0.4, 0.4);
        this.oldDitherMaterial.specularColor.set(1, 1, 1);
        this.oldDitherMaterial.shininess = 50;
        this.oldDitherMaterial.texture = null;

        this.noiseDitherMaterial.ambientColor.set(1, 0.4, 0.4);
        this.noiseDitherMaterial.diffuseColor.set(1, 0.4, 0.4);
        this.noiseDitherMaterial.specularColor.set(1, 1, 1);
        this.noiseDitherMaterial.shininess = 50;
        this.noiseDitherMaterial.texture = null;
